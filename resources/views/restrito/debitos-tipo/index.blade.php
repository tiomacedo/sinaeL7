...
<a href='{{url("/restrito/debitos-tipo/cadastrar")}}' 
        ...
        <div class='card-box table-responsive'>
            <table id='datatable' class='table table-striped table-bordered  text-uppercase'>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$registro->TD_CODIGO}}</td>
                        <td>{{$registro->TD_DESCRICAO}}</td>
                        <td style='text-align: right'>
                            <a href='#' class='btn btn-xs waves-effect btn-danger tooltip-hover' title='Excluir'
                               onclick="deletar('{{url("/restrito/debitos-tipo/deletar/$registro->TD_CODIGO")}}')" id='urlDeletar'>
                                <i class='fa fa-trash'></i>
                            </a>
                            <a href='{{url("/restrito/debitos-tipo/editar/$registro->TD_CODIGO")}}' 
