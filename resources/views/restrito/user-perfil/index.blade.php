...
<div class='row'>
    <div class='col-sm-12'>
        <div class='page-title-box'>
            ...
            <h4 class='page-title'>Tipos de Perfis | <small>Gerenciamento de Registros</small></h4>
        </div>
    </div>
</div>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href='#' class='btn btn-xs waves-effect btn-danger'
                               onclick="deletar('{{url("/restrito/perfil/deletar/$registro->id")}}')" id='urlDeletar'>
                                <i class='fa fa-trash'></i>
                            </a>
                            <a href='#' class='btn btn-xs waves-effect btn-success'
                               onclick="edit('{{url("/restrito/perfil/editar/$registro->id")}}')" id='edit'>
    ...
    <div class='modal-dialog' role='document'>
        <div class='modal-content'>
            ...
            <div class='modal-body'>
                ...
                <form method='POST' action="{{url('/restrito/perfil/cadastrar')}}" id='form' 
                      class='bottom-margin' form-send="{{url('/restrito/perfil/cadastrar')}}">
                    {{csrf_field()}}
                    <fieldset>
                        <div class='row'>
