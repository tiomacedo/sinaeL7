...
<a href='{{url("/restrito/missionarias/cadastrar")}}' class='btn btn-primary waves-effect waves-light'>Novo Registro</a>
<div class='row'>
    <div class='col-sm-12'>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style='text-align: center'>
                            ...
                            <a href='{{url("/restrito/missionarias/endereco/editar/$registro->END_CODIGO")}}'
                            ...
                            @else
                            <a href='{{url("/restrito/missionarias/endereco/cadastrar/$registro->id")}}' 
                        ...
                        <td style='text-align: center'>
                            ...
                            <a href='{{url("/restrito/missionarias/dados-eclesiasticos/editar/$registro->DEM_CODIGO")}}'
                            ...
                            @else
                            <a href='{{url("/restrito/missionarias/dados-eclesiasticos/cadastrar/$registro->id")}}'
                        ...
                        <!-- DEPENDENTES -->
                        <td style='text-align: center'>
                            <a href='{{url("/restrito/missionarias/dependentes/$registro->id")}}'
                        ...
                        <td style='text-align: center'>
                            ...
                            <a href='{{url("/restrito/missionarias/dados-bancarios/editar/$registro->BAN_CODIGO")}}' 
                               class='btn btn-xs btn-success waves-effect waves-light tooltip-hover'
                               title='Alterar Dados Bancários' >
                                <i class='mdi mdi-cash-multiple'></i> 
                            </a>
                            @else
                            <a href='{{url("/restrito/missionarias/dados-bancarios/cadastrar/$registro->id")}}'
                               class='btn btn-xs btn-primary waves-effect waves-light tooltip-hover' 
                        ...
                        <!--BOTÕES DE INTERAÇÃO-->
                        <td>
                            <a href='{{url("/restrito/missionarias/view/$registro->id")}}' 
                            ...
                            <a href='#' class='btn btn-xs waves-effect btn-danger tooltip-hover' title='Excluir registro' 
                               onclick="deletar('{{url("/restrito/missionarias/deletar/$registro->id")}}')" id='urlDeletar' >
                                <i class='fa fa-trash'></i>
                            </a>
                            <a href='{{url("/restrito/missionarias/editar/$registro->id")}}' 
