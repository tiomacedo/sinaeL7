            ...
            <div class='btn-group pull-right'>
                <h4>
                    <ol class='breadcrumb hide-phone p-0 m-0'>
                        ...
                        <li class='active text-uppercase'><a href='{{url("/restrito/ministros")}}'>MINISTROS</a></li>
                    </ol>
                </h4>
            </div>
            <h4 class='page-title'>FICHA COMPLETA DO MINISTRO <small></small></h4>
        </div>
    </div>
</div>
                        ...
                        <div class='modal-body'>
                            ...
                            <div class='row manager divisory'>
                                ...
                                <div class='input-field col-md-2'>
                                    ...
                                    <br/>
                                    <span id='SPAN_cellphone2' class='text-uppercase'>{{$registro->cellphone2}}</span>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class='modal-body'>
                            <div class='row manager divisory'>
                                ...
                                <div class='input-field col-md-2'>
                                    <label for=''>SUP. DE ÁREA</label> <br/>
                            ...
                            <div class='row manager divisory'>
                                ...
                                <div class='input-field col-md-2'>
                                    ...
                                    @if($dem->DEM_DTMUDANCADEAREA != null)
                                    <span>{{ \Carbon\Carbon::parse($dem->DEM_DTMUDANCADEAREA)->format('d/m/Y')}}</span>
                                    @endif
                                </div>
                                <div class='input-field col-md-2'>
                                ...
                                <div class='input-field col-md-2'>
                                    ...
                                    @if($dem->DEM_DTCONGREGADODESDE != null)
                                    <span>{{ \Carbon\Carbon::parse($dem->DEM_DTCONGREGADODESDE)->format('d/m/Y')}}</span>
                                    @endif
                                </div>
                                <div class='input-field col-md-2'>
                                    <label for=''>AUXILIAR DESDE</label> <br/>
                                    @if($dem->DEM_DTAUXILIAR != null)
                                    <span>{{ \Carbon\Carbon::parse($dem->DEM_DTAUXILIAR)->format('d/m/Y')}}</span>
                                    @endif
                                </div>
                                <div class='input-field col-md-2'>
                                    <label for=''>DIÁCONO DESDE</label> <br/>
                                    @if($dem->DEM_DTDIACONO != null)
                                    <span>{{ \Carbon\Carbon::parse($dem->DEM_DTDIACONO)->format('d/m/Y')}}</span>
                                    @endif
                                </div>
                            </div>
                            <div class='row manager divisory'>
                                <div class='input-field col-md-2'>
                                    ...
                                    @if($dem->DEM_DTPRESBITERO != null)
                                    <span>{{ \Carbon\Carbon::parse($dem->DEM_DTPRESBITERO)->format('d/m/Y')}}</span>
                                    @endif
                                </div>
                                <div class='input-field col-md-2'>
                                    <label for=''>EVANGELISTA DESDE</label> <br/>
                                    @if($dem->DEM_DTEVANGELISTA != null)
                                    <span>{{ \Carbon\Carbon::parse($dem->DEM_DTEVANGELISTA)->format('d/m/Y')}}</span>
                                    @endif
                                </div>
                                <div class='input-field col-md-2'>
                                    <label for=''>DIRIGENTE DESDE</label> <br/>
                                    @if($dem->DEM_DTDIRIGENTE != null)
                                    <span>{{ \Carbon\Carbon::parse($dem->DEM_DTDIRIGENTE)->format('d/m/Y')}}</span>
                                    @endif
                                </div>
                                <div class='input-field col-md-2'>
                                    <label for=''>PASTOR DESDE</label> <br/>
                                    @if($dem->DEM_DTPASTOR != null)
                                    <span>{{ \Carbon\Carbon::parse($dem->DEM_DTPASTOR)->format('d/m/Y')}}</span>
                                    @endif
                                </div>
                                <div class='input-field col-md-2'>
                                    <label for=''>DT. ACLAMAÇÃO</label> <br/>
                                    @if($dem->DEM_DTACLAMACAO != null)
                                    <span>{{ \Carbon\Carbon::parse($dem->DEM_DTACLAMACAO)->format('d/m/Y')}}</span>
                                    @endif
                                </div>
                                <div class='input-field col-md-2'>
                                    <label for=''>DT. CONSAGRAÇÃO</label> <br/>
                                    @if($dem->DEM_DTCONSAGRACAO != null)
                                    <span>{{ \Carbon\Carbon::parse($dem->DEM_DTCONSAGRACAO)->format('d/m/Y')}}</span>
                                    @endif
                                </div>
                            </div>
                            <div class='row manager divisory'>
                                <div class='input-field col-md-2'>
                                    ...
                                    @if($dem->DEM_DTORDENACAO != null)
                                    <span>{{ \Carbon\Carbon::parse($dem->DEM_DTORDENACAO)->format('d/m/Y')}}</span>
                                    @endif
                                </div>
                                <div class='input-field col-md-2'>
                                ...
                                <div class='input-field col-md-2'>
                                    ...
                                    <span>{{ \Carbon\Carbon::parse($dem->DEM_DTBATISMOESPIRITO)->format('d/m/Y')}}</span>
                                    @endif
                                </div>
                                <div class='input-field col-md-2'>
                                ...
                                <div class='input-field col-md-2'>
                                    ...
                                    @if($dem->DEM_DTJUBILADO != null)
                                    <span>{{ \Carbon\Carbon::parse($dem->DEM_DTJUBILADO)->format('d/m/Y')}}</span>
                                    @endif
                                </div>
                            </div>
                            <div class='row manager divisory'>
