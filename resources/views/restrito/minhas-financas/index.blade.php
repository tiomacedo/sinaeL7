            ...
            <div class='btn-group pull-right'>
                <h4>
                    <ol class='breadcrumb hide-phone p-0 m-0'>
                        ...
                        <li class='active'>Meus Boletos</li>
                    </ol>
                </h4>
            </div>
            <h4 class='page-title text-uppercase'>BOLETOS GERADOS PARA ({{Auth::user()->name}})</h4>
        </div>
    </div>
</div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style='text-align: right'>
                            <a href='{{url("/restrito/meus-boletos/$registro->REC_CODIGO")}}' 
                               target='_blank' class='btn waves-effect btn-orange btn-xs tooltip-hover' title='Visualizar Boleto'>
