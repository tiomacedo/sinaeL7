            ...
            <div class='btn-group pull-right'>
                <h4>
                    <ol class='breadcrumb hide-phone p-0 m-0'>
                        ...
                        <li> <a href='{{url('/restrito/solicitacoes/responder')}}'>RESPONDER AS SOLICITAÇÕES</a> </li>
                    </ol>
                </h4>
            </div>
            <h4 class='page-title'>RESPONDER CHAMADOS | <small>GERENCIAMENTO DOS REGISTROS</small></h4>
        </div>
    </div>
</div>
    ...
    <div class="col-sm-12">
        ...
        <div class="timeline timeline-left">
                    ...
                    <div class="panel">
                        <div class="timeline-box">
                            ...
                            <a href='#' class='btn btn-xs waves-effect btn-danger'
                               onclick="deletar('{{url("/restrito/solicitacao/deletar-resposta/$registro->SOL_CODIGO")}}')" id='urlDeletar'>
            ...
            <a href='#' class='btn btn-primary waves-effect waves-light'
               onclick="edit('{{url("/restrito/solicitacao/responder/$registro->SOL_CODIGO")}}')" id='edit'>
                <i class='fa fa-pencil'></i> RESPONDER SOLICITAÇÃO
            </a>
            @endif
                ...
                <div class='modal-body'>
                    <div class='row manager'>
                        <div class='input-field col-md-12'>
                            <label for='SOL_RESPOSTA'>RESPOSTA</label>
                            <textarea name='SOL_RESPOSTA' id='SOL_RESPOSTA' class='form-control'>
