...
<div class='row'>
    <div class='col-sm-12'>
        <div class='page-title-box'>
            ...
            <h4 class='page-title'>Lixeira | <small>Gerenciamento de Registros</small></h4>
        </div>
    </div>
</div>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href='#' class='btn btn-xs waves-effect btn-danger tooltip-hover' title='Excluir registro Permanente' 
                               onclick="deletar('{{url("/restrito/usuarios-deletados/deletar/$registro->id")}}')" id='urlDeletar'>
                                <i class='fa fa-trash'></i>
                            </a>
                            <a href='#' class='btn btn-xs waves-effect btn-success tooltip-hover' title='Restaurar registro'
                               onclick="edit('{{url("/restrito/usuarios-deletados/restaurar/$registro->id")}}')" >
