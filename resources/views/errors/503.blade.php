                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <div class="wrapper-page">
                            ...
                            <h3 class="text-uppercase text-danger">SERVIÇO INDISPONÍVEL</h3>
                            <p class="text-muted">A página está indisponível no momento. 
                                Por favor informe essse erro ao nosso suporte para que seja regularizado o mais breve possível.
                                <a mailto="contato@bemfuncional.com" class="text-primary">E-mail para o suporte: contato@bemfuncional.com</a>
                            </p>
